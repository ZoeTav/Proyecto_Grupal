...
$(document).ready(function() {
   ...
   $("#shareButton").on("click", shareOnTwitter);
 });

function getMyRandomQuote(){
  var myRandomArtistArray = ["Mercedes Sosa", "Atahualpa Yupanqui", "León Gieco", "Charly García", "Alí Primera", "Facundo Cabral"];
  var myNewQuote = "";
  var myRandomIndexArtist = randomRange(0, myRandomArtistArray.length - 1);//myRandomArtistArray.length - 1
  var autor = myRandomArtistArray[myRandomIndexArtist];
