...
const url= `https://graph.instagram.com/v11.0/17841449614731486/media?fields=business_discovery.username({ceramic.art_proyecto}){media_url,caption,permalink&limit=80}&access_token=${token}`;
